...
Your entire response should be a single line starting with either FUNCTION_CALL: or FINAL_ANSWER:"""
                ...
                query = """Add the numbers 3,4,5 and get the sum. 
                Afer that, open Paintbrush app, draw a rectangle from (400,300) to (600,500) add the final answer as text in the rectangle  """
